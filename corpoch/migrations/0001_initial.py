# Generated by Django 6.0.1 on 2026-02-01 23:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players', to='corpoch.tournamentplayer', verbose_name='Group Seed')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screenshot', models.ImageField(null=True, upload_to='tournament_screens/', verbose_name='Screenshot')),
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model__in': ('TournamentMatchOngoing', 'TournamentMatchCompleted')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ...
                ('loser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rounds_lost', to='corpoch.tournamentplayer', verbose_name='Loser')),
